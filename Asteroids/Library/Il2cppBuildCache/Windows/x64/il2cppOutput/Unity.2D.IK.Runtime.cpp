...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool CCD2D_Solve_m7C131A12642533B8C236B2A3FF1F40EE67E9B1E5 (Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  ___targetPosition0, Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  ___forward1, int32_t ___solverLimit2, float ___tolerance3, float ___velocity4, Vector3U5BU5D_t5FB88EAA33E46838BDC2ABDAEA3E8727491CB9E4** ___positions5, const RuntimeMethod* method)
{
	...
	{
		// int last U3D positions.Length U2D 1U3B
		...
		// int iterations U3D 0U3B
		V_1 = 0;
		// float sqrTolerance U3D tolerance * toleranceU3B
		float L_2 = ___tolerance3;
		float L_3 = ___tolerance3;
		V_2 = ((float)il2cpp_codegen_multiply((float)L_2, (float)L_3));
		// float sqrDistanceToTarget U3D (targetPosition U2D positions[last]).sqrMagnitudeU3B
...
IL_0029:
	{
		// DoIteration(targetPosition, forward, last, velocity, ref positions)U3B
		...
		// sqrDistanceToTarget U3D (targetPosition U2D positions[last]).sqrMagnitudeU3B
		...
		V_3 = L_24;
		// if (U2BU2Biterations >U3D solverLimit)
		int32_t L_25 = V_1;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CCD2D_DoIteration_m7D1A6F51429A7FE777156C1BA76EE30C65610423 (Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  ___targetPosition0, Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  ___forward1, int32_t ___last2, float ___velocity3, Vector3U5BU5D_t5FB88EAA33E46838BDC2ABDAEA3E8727491CB9E4** ___positions4, const RuntimeMethod* method)
{
	...
	int32_t V_4 = 0;
	{
		// for (int i U3D last U2D 1U3B i >U3D 0U3B U2DU2Di)
...
IL_0006:
	{
		// Vector3 toTarget U3D targetPosition U2D positions[i]U3B
		...
		V_1 = L_7;
		// Vector3 toLast U3D positions[last] U2D positions[i]U3B
		...
		// float angle U3D Vector3.SignedAngle(toLast, toTarget, forward)U3B
		...
		V_3 = L_27;
		// for (int j U3D lastU3B j > iU3B U2DU2Dj)
...
IL_004f:
	{
		// positions[j] U3D RotatePositionFrom(positions[j], positions[i], deltaRotation)U3B
		...
		NullCheck(L_30);
		(L_30)->SetAt(static_cast<il2cpp_array_size_t>(L_31), (Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E )L_43);
		// for (int j U3D lastU3B j > iU3B U2DU2Dj)
		int32_t L_44 = V_4;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  CCD2D_RotatePositionFrom_m4F421FBEBD89BFE0EF6321CF3996E6DAE1F209C4 (Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  ___position0, Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  ___pivot1, Quaternion_t6D28618CF65156D4A0AD747370DDFD0C514A31B4  ___rotation2, const RuntimeMethod* method)
{
	...
	{
		// Vector3 v U3D position U2D pivotU3B
...
{
	{
		// get U7B return m_IterationsU3B U7D
...
{
	{
		// set U7B m_Iterations U3D Mathf.Max(value, kMinIterations)U3B U7D
...
{
	{
		// get U7B return m_ToleranceU3B U7D
...
{
	{
		// set U7B m_Tolerance U3D Mathf.Max(value, kMinTolerance)U3B U7D
		float L_0 = ___value0;
		float L_1;
...
{
	{
		// get U7B return m_VelocityU3B U7D
...
{
	{
		// set U7B m_Velocity U3D Mathf.Clamp01(value)U3B U7D
		float L_0 = ___value0;
		float L_1;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CCDSolver2D_DoPrepare_m493568C24CD5B8759CA47A09627E818616D02C1E (CCDSolver2D_t6A0F493058D78FED67126D42F5A1A423298284BE * __this, const RuntimeMethod* method)
{
	...
	int32_t V_0 = 0;
	{
		// if (m_Positions U3DU3D null U7CU7C m_Positions.Length U21U3D m_Chain.transformCount)
...
IL_001d:
	{
		// m_Positions U3D new Vector3[m_Chain.transformCount]U3B
...
IL_0033:
	{
		// for (int i U3D 0U3B i < m_Chain.transformCountU3B U2BU2Bi)
		V_0 = 0;
		goto IL_0059;
	}
...
IL_0037:
	{
		// m_Positions[i] U3D m_Chain.transforms[i].positionU3B
		...
		NullCheck(L_7);
		(L_7)->SetAt(static_cast<il2cpp_array_size_t>(L_8), (Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E )L_14);
		// for (int i U3D 0U3B i < m_Chain.transformCountU3B U2BU2Bi)
		int32_t L_15 = V_0;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CCDSolver2D_DoUpdateIK_m44204DE0B6AA4A1641EB29F41073756C9397487F (CCDSolver2D_t6A0F493058D78FED67126D42F5A1A423298284BE * __this, List_1_t577D28CFF6DFE3F6A8D4409F7A21CBF513C04181 * ___effectorPositions0, const RuntimeMethod* method)
{
	...
	memset((&V_4), 0, sizeof(V_4));
	{
		// Vector3 effectorPosition U3D effectorPositions[0]U3B
		...
		V_0 = L_1;
		// Vector2 effectorLocalPosition2D U3D m_Chain.transforms[0].InverseTransformPoint(effectorPosition)U3B
		IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * L_2 = __this->get_m_Chain_13();
		NullCheck(L_2);
		...
		V_1 = L_8;
		// effectorPosition U3D m_Chain.transforms[0].TransformPoint(effectorLocalPosition2D)U3B
		IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * L_9 = __this->get_m_Chain_13();
		NullCheck(L_9);
		TransformU5BU5D_t7821C0520CC567C0A069329C01AE9C058C7E3F1D* L_10;
		L_10 = IKChain2D_get_transforms_m1CF36244C840CA67533FF798D82DEAAFF121F86B_inline(L_9, /*hidden argument*/NULL);
	...
	{
		// for (int i U3D 0U3B i < m_Chain.transformCount U2D 1U3B U2BU2Bi)
		V_2 = 0;
		goto IL_00d8;
	}
...
IL_0078:
	{
		// Vector3 startLocalPosition U3D m_Chain.transforms[i U2B 1].localPositionU3B
		...
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_29 = (L_26)->GetAt(static_cast<il2cpp_array_size_t>(L_28));
		NullCheck(L_29);
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_30;
		L_30 = Transform_get_localPosition_m527B8B5B625DA9A61E551E0FBCD3BE8CA4539FC2(L_29, /*hidden argument*/NULL);
		V_3 = L_30;
		// Vector3 endLocalPosition U3D m_Chain.transforms[i].InverseTransformPoint(m_Positions[i U2B 1])U3B
		...
		V_4 = L_40;
		// m_Chain.transforms[i].localRotation *U3D Quaternion.FromToRotation(startLocalPosition, endLocalPosition)U3B
		...
		NullCheck(L_42);
		int32_t L_44 = L_43;
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_45 = (L_42)->GetAt(static_cast<il2cpp_array_size_t>(L_44));
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CCDSolver2D__ctor_mEC83E99C3BF83ABF9CA118FA3C5D0C8EEC644E06 (CCDSolver2D_t6A0F493058D78FED67126D42F5A1A423298284BE * __this, const RuntimeMethod* method)
{
	...
	{
		// private IKChain2D m_Chain U3D new IKChain2D()U3B
		...
		// private int m_Iterations U3D 10U3B
		__this->set_m_Iterations_14(((int32_t)10));
		// private float m_Tolerance U3D 0.01fU3B
		__this->set_m_Tolerance_15((0.00999999978f));
		// private float m_Velocity U3D 0.5fU3B
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool FABRIK2D_Solve_mDBACC6E4D2F9479A6171910E08A1EA8A455A5580 (Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  ___targetPosition0, int32_t ___solverLimit1, float ___tolerance2, SingleU5BU5D_t47E8DBF5B597C122478D1FFBD9DD57399A0650FA* ___lengths3, Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA** ___positions4, const RuntimeMethod* method)
{
	...
	memset((&V_5), 0, sizeof(V_5));
	{
		...
		V_3 = L_11;
		// Vector2 originPosition U3D positions[0]U3B
...
IL_0034:
	{
		// Forward(targetPosition, lengths, ref positions)U3B
		...
		// Backward(originPosition, lengths, ref positions)U3B
...
IL_000b:
	{
		// for (int iterations U3D 0U3B iterations < solverLimitU3B U2BU2Biterations)
		V_0 = 0;
		goto IL_0023;
	}
...
IL_000f:
	{
		// SolveForwardsChain(0, ref chains)U3B
		...
		// if (U21SolveBackwardsChain(0, ref chains))
...
IL_0006:
	{
		...
		V_2 = L_4;
		// if (chain.subChainIndices.Length U3DU3D 0 && (chain.target U2D chain.last).sqrMagnitude > chain.sqrTolerance)
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FABRIK2D_SolveForwardsChain_m5FE322F4779E9476181D5F20C59CC68FAAED7727 (int32_t ___idx0, FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2** ___chains1, const RuntimeMethod* method)
{
	...
	int32_t V_2 = 0;
	{
		// var target U3D chains[idx].targetU3B
		FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2** L_0 = ___chains1;
		FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2* L_1 = *((FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2**)L_0);
		int32_t L_2 = ___idx0;
		NullCheck(L_1);
	...
	{
		// target U3D Vector2.zeroU3B
		Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  L_8;
		L_8 = Vector2_get_zero_m621041B9DF5FAE86C1EF4CB28C224FEA089CB828(/*hidden argument*/NULL);
		V_0 = L_8;
		// for (int i U3D 0U3B i < chains[idx].subChainIndices.LengthU3B U2BU2Bi)
		V_1 = 0;
		goto IL_0057;
	}
...
IL_0028:
	{
		// var childIdx U3D chains[idx].subChainIndices[i]U3B
		...
		NullCheck(L_10);
		Int32U5BU5D_t70F1BDC14B1786481B176D6139A5E3B87DC54C32* L_12 = ((L_10)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_11)))->get_subChainIndices_5();
		int32_t L_13 = V_1;
		NullCheck(L_12);
		int32_t L_14 = L_13;
		int32_t L_15 = (L_12)->GetAt(static_cast<il2cpp_array_size_t>(L_14));
		V_2 = L_15;
		// SolveForwardsChain(childIdx, ref chains)U3B
		int32_t L_16 = V_2;
		...
		// target U2BU3D chains[childIdx].firstU3B
		...
		L_22 = FABRIKChain2D_get_first_m3B7A5DADFA5DEBB6C1882ED237BD390F3E713C5A((FABRIKChain2D_t005A8D2E350FD757389CE28D0253E6D8EFCD5D59 *)((L_20)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_21))), /*hidden argument*/NULL);
...
IL_0057:
	{
		...
		NullCheck(L_27);
		Int32U5BU5D_t70F1BDC14B1786481B176D6139A5E3B87DC54C32* L_29 = ((L_27)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_28)))->get_subChainIndices_5();
		NullCheck(L_29);
	...
	{
		// target U3D target / chains[idx].subChainIndices.LengthU3B
		...
		NullCheck(L_32);
		Int32U5BU5D_t70F1BDC14B1786481B176D6139A5E3B87DC54C32* L_34 = ((L_32)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_33)))->get_subChainIndices_5();
		NullCheck(L_34);
...
IL_0080:
	{
		// Forward(target, chains[idx].lengths, ref chains[idx].positions)U3B
		...
		NullCheck(L_38);
		SingleU5BU5D_t47E8DBF5B597C122478D1FFBD9DD57399A0650FA* L_40 = ((L_38)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_39)))->get_lengths_4();
		...
		NullCheck(L_42);
		Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA** L_44 = ((L_42)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_43)))->get_address_of_positions_3();
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool FABRIK2D_SolveBackwardsChain_mEA0A100EED6E133E75D321701AB5D2C8869D11FE (int32_t ___idx0, FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2** ___chains1, const RuntimeMethod* method)
{
	...
	memset((&V_3), 0, sizeof(V_3));
	{
		// bool notSolved U3D falseU3B
		V_0 = (bool)0;
		// Backward(chains[idx].origin, chains[idx].lengths, ref chains[idx].positions)U3B
		FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2** L_0 = ___chains1;
		FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2* L_1 = *((FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2**)L_0);
		int32_t L_2 = ___idx0;
		NullCheck(L_1);
...
IL_0032:
	{
		...
		V_2 = L_18;
		// chains[childIdx].origin U3D chains[idx].lastU3B
		FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2** L_19 = ___chains1;
		FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2* L_20 = *((FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2**)L_19);
		int32_t L_21 = V_2;
		NullCheck(L_20);
		...
		// notSolved U7CU3D SolveBackwardsChain(childIdx, ref chains)U3B
		bool L_26 = V_0;
		int32_t L_27 = V_2;
...
IL_006a:
	...
	{
		// if (chains[idx].subChainIndices.Length U3DU3D 0)
		...
		NullCheck(L_37);
		Int32U5BU5D_t70F1BDC14B1786481B176D6139A5E3B87DC54C32* L_39 = ((L_37)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_38)))->get_subChainIndices_5();
		NullCheck(L_39);
	...
	{
		// notSolved U7CU3D (chains[idx].target U2D chains[idx].last).sqrMagnitude > chains[idx].sqrToleranceU3B
		bool L_40 = V_0;
		FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2** L_41 = ___chains1;
		FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2* L_42 = *((FABRIKChain2DU5BU5D_tBE7BA5B6396B9F466342E303193EA44ABCAB42F2**)L_41);
		int32_t L_43 = ___idx0;
		NullCheck(L_42);
		Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  L_44 = ((L_42)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_43)))->get_target_1();
		...
		L_48 = FABRIKChain2D_get_last_m6ED44B613CAB74F7306D814AF15A9792E8BE8546((FABRIKChain2D_t005A8D2E350FD757389CE28D0253E6D8EFCD5D59 *)((L_46)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_47))), /*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FABRIK2D_Forward_m7C7FE55BAD6886E44F94015A613B5717EC7B1D12 (Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  ___targetPosition0, SingleU5BU5D_t47E8DBF5B597C122478D1FFBD9DD57399A0650FA* ___lengths1, Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA** ___positions2, const RuntimeMethod* method)
{
	...
	memset((&V_4), 0, sizeof(V_4));
	{
		// var last U3D positions.Length U2D 1U3B
		Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA** L_0 = ___positions2;
		Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA* L_1 = *((Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA**)L_0);
		NullCheck(L_1);
		V_0 = ((int32_t)il2cpp_codegen_subtract((int32_t)((int32_t)((int32_t)(((RuntimeArray*)L_1)->max_length))), (int32_t)1));
		// positions[last] U3D targetPositionU3B
...
IL_0016:
	{
		// var r U3D positions[i U2B 1] U2D positions[i]U3B
		...
		V_2 = L_17;
		// var l U3D lengths[i] / r.magnitudeU3B
		...
		// var position U3D (1f U2D l) * positions[i U2B 1] U2B l * positions[i]U3B
		float L_23 = V_3;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FABRIK2D_Backward_mFD8C1326375670D404930BDA24819392A8F882CF (Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  ___originPosition0, SingleU5BU5D_t47E8DBF5B597C122478D1FFBD9DD57399A0650FA* ___lengths1, Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA** ___positions2, const RuntimeMethod* method)
{
	...
	memset((&V_4), 0, sizeof(V_4));
	{
		// positions[0] U3D originPositionU3B
		Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA** L_0 = ___positions2;
		Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA* L_1 = *((Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA**)L_0);
		...
		// for (int i U3D 0U3B i < lastU3B U2BU2Bi)
		V_1 = 0;
		goto IL_0073;
	}
...
IL_0014:
	{
		...
		// var position U3D (1f U2D l) * positions[i] U2B l * positions[i U2B 1]U3B
		float L_21 = V_3;
		...
		V_4 = L_35;
		// positions[i U2B 1] U3D positionU3B
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  FABRIK2D_ValidateJoint_m1DF2870F51889EA753C75C88649A3DBE97BB36D1 (Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  ___endPosition0, Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  ___startPosition1, Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  ___right2, float ___min3, float ___max4, const RuntimeMethod* method)
{
	...
	memset((&V_4), 0, sizeof(V_4));
	{
		// var localDifference U3D endPosition U2D startPositionU3B
		...
		V_0 = L_2;
		// var angle U3D Vector2.SignedAngle(right, localDifference)U3B
		...
		V_1 = L_5;
		// var validatedPosition U3D endPositionU3B
	...
	{
		// var minRotation U3D Quaternion.Euler(0f, 0f, min)U3B
		float L_9 = ___min3;
		...
		V_3 = L_10;
		// validatedPosition U3D startPosition U2B (Vector2)(minRotation * right * localDifference.magnitude)U3B
...
IL_004d:
	...
	{
		// var maxRotation U3D Quaternion.Euler(0f, 0f, max)U3B
		float L_22 = ___max4;
		...
		V_4 = L_23;
		// validatedPosition U3D startPosition U2B (Vector2)(maxRotation * right * localDifference.magnitude)U3B
...
{
	{
		// get U7B return positions[0]U3B U7D
...
{
	{
		// get U7B return positions[positions.Length U2D 1]U3B U7D
		Vector2U5BU5D_tE0F58A2D6D8592B5EC37D9CDEF09103A02E5D7FA* L_0 = __this->get_positions_3();
...
IL_001d:
	{
		// m_Positions U3D new Vector2[m_Chain.transformCount]U3B
		...
		// m_Lengths U3D new float[m_Chain.transformCount U2D 1]U3B
		...
		// m_WorldPositions U3D new Vector3[m_Chain.transformCount]U3B
...
IL_0065:
	{
		// m_Positions[i] U3D GetPointOnSolverPlane(m_Chain.transforms[i].position)U3B
		...
		NullCheck(L_16);
		int32_t L_18 = L_17;
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_19 = (L_16)->GetAt(static_cast<il2cpp_array_size_t>(L_18));
		NullCheck(L_19);
		...
		NullCheck(L_13);
		(L_13)->SetAt(static_cast<il2cpp_array_size_t>(L_14), (Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9 )L_22);
		// for (int i U3D 0U3B i < m_Chain.transformCountU3B U2BU2Bi)
		int32_t L_23 = V_0;
...
IL_00a4:
	{
		// m_Lengths[i] U3D (m_Positions[i U2B 1] U2D m_Positions[i]).magnitudeU3B
		...
		NullCheck(L_33);
		int32_t L_35 = L_34;
		Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  L_36 = (L_33)->GetAt(static_cast<il2cpp_array_size_t>(L_35));
		Vector2_tBB32F2736AEC229A7BFBCE18197EC0F6AC7EC2D9  L_37;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FabrikSolver2D_DoUpdateIK_mA8967BDE17AE9AF65258E3FC1DD1BD1D0A1C2E4D (FabrikSolver2D_t1E01919887CE09EF05A596F2E53DA2CA8359C1FC * __this, List_1_t577D28CFF6DFE3F6A8D4409F7A21CBF513C04181 * ___effectorPositions0, const RuntimeMethod* method)
{
	...
	memset((&V_4), 0, sizeof(V_4));
	{
		...
		L_1 = List_1_get_Item_m863D7819591108234EBC5D9C037281E7937937E4_inline(L_0, 0, /*hidden argument*/List_1_get_Item_m863D7819591108234EBC5D9C037281E7937937E4_RuntimeMethod_var);
		V_0 = L_1;
		// effectorPosition U3D GetPointOnSolverPlane(effectorPosition)U3B
	...
	{
		// for (int i U3D 0U3B i < m_Positions.LengthU3B U2BU2Bi)
		V_1 = 0;
		goto IL_005e;
	}
...
IL_003c:
	{
		// m_WorldPositions[i] U3D GetWorldPositionFromSolverPlanePoint(m_Positions[i])U3B
		...
		NullCheck(L_11);
		(L_11)->SetAt(static_cast<il2cpp_array_size_t>(L_12), (Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E )L_17);
		// for (int i U3D 0U3B i < m_Positions.LengthU3B U2BU2Bi)
		int32_t L_18 = V_1;
...
IL_006d:
	{
		...
		V_3 = L_26;
		// Vector3 endLocalPosition U3D m_Chain.transforms[i].InverseTransformPoint(m_WorldPositions[i U2B 1])U3B
		...
		NullCheck(L_28);
		int32_t L_30 = L_29;
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_31 = (L_28)->GetAt(static_cast<il2cpp_array_size_t>(L_30));
...
{
	{
		// get U7B return m_EffectorTransformU3B U7D
...
{
	{
		// set U7B m_EffectorTransform U3D valueU3B U7D
...
{
	{
		// get U7B return m_TargetTransformU3B U7D
...
{
	{
		// set U7B m_TargetTransform U3D valueU3B U7D
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_0 = ___value0;
...
{
	{
		// get U7B return m_TransformsU3B U7D
...
{
	{
		// if (m_Transforms U21U3D null && transformCount > 0 && m_Transforms.Length U3DU3D transformCount)
		TransformU5BU5D_t7821C0520CC567C0A069329C01AE9C058C7E3F1D* L_0 = __this->get_m_Transforms_3();
		if (!L_0)
		{
			goto IL_002a;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * IKChain2D_get_lastTransform_m2BADDA09E4D23103EB3B1B48D48CA37051F5E7E9 (IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * __this, const RuntimeMethod* method)
{
	...
	{
		// return m_Transforms[transformCount U2D 1]U3B
		TransformU5BU5D_t7821C0520CC567C0A069329C01AE9C058C7E3F1D* L_4 = __this->get_m_Transforms_3();
		int32_t L_5;
...
{
	{
		// get U7B return m_TransformCountU3B U7D
...
{
	{
		// set U7B m_TransformCount U3D Mathf.Max(0, value)U3B U7D
		int32_t L_0 = ___value0;
		int32_t L_1;
...
{
	{
		// get U7B return Validate()U3B U7D
		bool L_0;
...
IL_001a:
	{
		// if (m_Transforms U3DU3D null U7CU7C m_Transforms.Length U21U3D transformCount)
...
IL_0034:
	{
		// if (m_DefaultLocalRotations U3DU3D null U7CU7C m_DefaultLocalRotations.Length U21U3D transformCount)
...
IL_004e:
	{
		// if (m_StoredLocalRotations U3DU3D  null U7CU7C m_StoredLocalRotations.Length U21U3D transformCount)
...
IL_0078:
	{
		// if (lastTransform U21U3D effector)
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void IKChain2D_Initialize_mAD562B4CABDBD051BA9CCD30FD68BBF49990E3BA (IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * __this, const RuntimeMethod* method)
{
	...
	int32_t V_1 = 0;
	{
		// if (effector U3DU3D null U7CU7C transformCount U3DU3D 0 U7CU7C IKUtility.GetAncestorCount(effector) < transformCount U2D 1)
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_0;
		L_0 = IKChain2D_get_effector_m4C8436D4F6EF2A06DE5D4E852BA7C99D4D0E9046_inline(__this, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Object_tF2F3778131EFF286AF62B7B013A170F95A91571A_il2cpp_TypeInfo_var);
		bool L_1;
...
IL_002c:
	{
		// m_Transforms U3D new Transform[transformCount]U3B
		int32_t L_6;
		...
		// m_DefaultLocalRotations U3D new Quaternion[transformCount]U3B
		int32_t L_8;
		L_8 = IKChain2D_get_transformCount_mA9085C77FF8E063E4579AE3CBBCB448429CEF68B_inline(__this, /*hidden argument*/NULL);
		...
		// m_StoredLocalRotations U3D new Quaternion[transformCount]U3B
		int32_t L_10;
...
IL_0071:
	{
		// m_Transforms[index] U3D currentTransformU3B
		...
		(L_14)->SetAt(static_cast<il2cpp_array_size_t>(L_15), (Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 *)L_16);
		// m_DefaultLocalRotations[index] U3D currentTransform.localRotationU3B
		...
		NullCheck(L_17);
		(L_17)->SetAt(static_cast<il2cpp_array_size_t>(L_18), (Quaternion_t6D28618CF65156D4A0AD747370DDFD0C514A31B4 )L_20);
		// currentTransform U3D currentTransform.parentU3B
...
IL_0097:
	{
		// while (currentTransform && index >U3D 0)
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void IKChain2D_PrepareLengths_mD4BE7E28775C08918AB06D8405632159B98BB90C (IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * __this, const RuntimeMethod* method)
{
	...
	memset((&V_2), 0, sizeof(V_2));
	{
		...
		// if (m_Lengths U3DU3D null U7CU7C m_Lengths.Length U21U3D transformCount U2D 1)
...
IL_002a:
	{
		// m_Lengths U3D new float[transformCount U2D 1]U3B
		int32_t L_5;
		L_5 = IKChain2D_get_transformCount_mA9085C77FF8E063E4579AE3CBBCB448429CEF68B_inline(__this, /*hidden argument*/NULL);
...
IL_003f:
	...
	{
		// m_Lengths[index U2D 1] U3D (currentTransform.position U2D currentTransform.parent.position).magnitudeU3B
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void IKChain2D_RestoreDefaultPose_m9078C5D10EB72B9F01682D9EE0419BCEBCD61D4C (IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * __this, bool ___targetRotationIsConstrained0, const RuntimeMethod* method)
{
	...
	int32_t G_B3_0 = 0;
	{
		// var count U3D targetRotationIsConstrained U3F transformCount : transformCountU2D1U3B
...
IL_0013:
	{
		V_0 = G_B3_0;
		// for (int i U3D 0U3B i < countU3B U2BU2Bi)
		V_1 = 0;
		goto IL_0035;
	}
...
IL_0018:
	{
		// m_Transforms[i].localRotation U3D m_DefaultLocalRotations[i]U3B
		TransformU5BU5D_t7821C0520CC567C0A069329C01AE9C058C7E3F1D* L_3 = __this->get_m_Transforms_3();
		int32_t L_4 = V_1;
		NullCheck(L_3);
		int32_t L_5 = L_4;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void IKChain2D_StoreLocalRotations_m7E529365BE433D59BB1D2A4282B4B21B1DC4E400 (IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * __this, const RuntimeMethod* method)
{
	int32_t V_0 = 0;
	{
		// for (int i U3D 0U3B i < m_Transforms.LengthU3B U2BU2Bi)
		V_0 = 0;
		goto IL_0021;
	}
...
IL_0004:
	{
		// m_StoredLocalRotations[i] U3D m_Transforms[i].localRotationU3B
...
IL_0018:
	{
		// m_Transforms[i].localRotation U3D Quaternion.Slerp(m_StoredLocalRotations[i], m_Transforms[i].localRotation, finalWeight)U3B
		TransformU5BU5D_t7821C0520CC567C0A069329C01AE9C058C7E3F1D* L_3 = __this->get_m_Transforms_3();
		int32_t L_4 = V_1;
		NullCheck(L_3);
		int32_t L_5 = L_4;
...
{
	{
		// get U7B return m_WeightU3B U7D
...
{
	{
		// set U7B m_Weight U3D Mathf.Clamp01(value)U3B U7D
		float L_0 = ___value0;
		float L_1;
		L_1 = Mathf_Clamp01_m2296D75F0F1292D5C8181C57007A1CA45F440C4C(L_0, /*hidden argument*/NULL);
...
{
	{
		// get U7B return m_SolversU3B U7D
...
{
	{
		// m_Weight U3D Mathf.Clamp01(m_Weight)U3B
		float L_0 = __this->get_m_Weight_5();
		float L_1;
		L_1 = Mathf_Clamp01_m2296D75F0F1292D5C8181C57007A1CA45F440C4C(L_0, /*hidden argument*/NULL);
		__this->set_m_Weight_5(L_1);
		// OnEditorDataValidate()U3B
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void IKManager2D_FindChildSolvers_m7EDD5127BA852896F46E5C4D76447DAEF9022064 (IKManager2D_tE48D1FE480E3DB82090AE160F5F29C18C7D74510 * __this, const RuntimeMethod* method)
{
	...
	il2cpp::utils::ExceptionSupportStack<int32_t, 1> __leave_targets;
	{
		...
		// List<Solver2D> solvers U3D new List<Solver2D>()U3B
		...
		V_0 = L_1;
		// transform.GetComponentsInChildren<Solver2D>(true, solvers)U3B
...
IL_0027:
		{
			...
			V_2 = L_6;
			// if (solver.GetComponentInParent<IKManager2D>() U3DU3D this)
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void IKManager2D_AddSolver_mC886398746EFCF678F39589E34AC602C5DA2BAEA (IKManager2D_tE48D1FE480E3DB82090AE160F5F29C18C7D74510 * __this, Solver2D_t8A225947B36460AC49D5388511B3BBE7E03FB2B6 * ___solver0, const RuntimeMethod* method)
{
	...
	{
		// if (U21m_Solvers.Contains(solver))
		List_1_t5AD9FC44D7FFD5B7D3AE07112E73513D3F17C479 * L_0 = __this->get_m_Solvers_4();
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void IKManager2D_RemoveSolver_mC4CE591F88DBA76AAB027D1D2BE6EA3EE688530E (IKManager2D_tE48D1FE480E3DB82090AE160F5F29C18C7D74510 * __this, Solver2D_t8A225947B36460AC49D5388511B3BBE7E03FB2B6 * ___solver0, const RuntimeMethod* method)
{
	...
	{
		// RemoveSolverEditorData(solver)U3B
...
IL_000e:
		{
			...
			V_1 = L_2;
			// if (solver U3DU3D null U7CU7C U21solver.isActiveAndEnabled)
...
{
	{
		// void OnEditorDataValidate()U7BU7D
		return;
	}
}
// System.Void UnityEngine.U2D.IK.IKManager2D::AddSolverEditorData()
...
{
	{
		// void AddSolverEditorData()U7BU7D
		return;
	}
}
// System.Void UnityEngine.U2D.IK.IKManager2D::RemoveSolverEditorData(UnityEngine.U2D.IK.Solver2D)
...
{
	{
		// void RemoveSolverEditorData(Solver2D solver)U7BU7D
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void IKManager2D__ctor_m002A5C6D45E373738321F8ABBCF9C794F41D3A0C (IKManager2D_tE48D1FE480E3DB82090AE160F5F29C18C7D74510 * __this, const RuntimeMethod* method)
{
	...
	{
		// private List<Solver2D> m_Solvers U3D new List<Solver2D>()U3B
		...
		// private float m_Weight U3D 1fU3B
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool IKUtility_IsDescendentOf_m62549D8A1C1F80AA41765ACB55D65BEDD5F785D4 (Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * ___transform0, Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * ___ancestor1, const RuntimeMethod* method)
{
	...
	Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * V_0 = NULL;
	{
		// Transform currentParent U3D transform.parentU3B
...
IL_0009:
	{
		// if (currentParent U3DU3D ancestor)
...
IL_0014:
	{
		// currentParent U3D currentParent.parentU3B
...
IL_0004:
	{
		// U2BU2BancestorCountU3B
		int32_t L_0 = V_0;
		V_0 = ((int32_t)il2cpp_codegen_add((int32_t)L_0, (int32_t)1));
		// transform U3D transform.parentU3B
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t IKUtility_GetMaxChainCount_m47D63524E83FC27958E44667D87A19DA76EE5C5D (IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * ___chain0, const RuntimeMethod* method)
{
	...
	{
		// maxChainCount U3D GetAncestorCount(chain.effector) U2B 1U3B
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Limb_Solve_m972DC483BE62D28C354BB162A4418EA875CC117C (Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  ___targetPosition0, SingleU5BU5D_t47E8DBF5B597C122478D1FFBD9DD57399A0650FA* ___lengths1, Vector3U5BU5D_t5FB88EAA33E46838BDC2ABDAEA3E8727491CB9E4* ___positions2, SingleU5BU5D_t47E8DBF5B597C122478D1FFBD9DD57399A0650FA** ___outAngles3, const RuntimeMethod* method)
{
	...
	float V_5 = 0.0f;
	{
		...
		// if (lengths[0] U3DU3D 0f U7CU7C lengths[1] U3DU3D 0f)
...
IL_0028:
	{
		// Vector3 startToEnd U3D targetPosition U2D positions[0]U3B
		...
		V_0 = L_14;
		// float distanceMagnitude U3D startToEnd.magnitudeU3B
		float L_15;
		...
		V_1 = L_15;
		// float sqrDistance U3D startToEnd.sqrMagnitudeU3B
		float L_16;
		...
		// float sqrParentLength U3D (lengths[0] * lengths[0])U3B
		...
		// float sqrTargetLength U3D (lengths[1] * lengths[1])U3B
		...
		// float angle0Cos U3D (sqrDistance U2B sqrParentLength U2D sqrTargetLength) / (2f * lengths[0] * distanceMagnitude)U3B
		float L_29 = L_16;
		float L_30 = V_2;
		float L_31 = V_3;
		...
		// float angle1Cos U3D (sqrDistance U2D sqrParentLength U2D sqrTargetLength) / (2f * lengths[0] * lengths[1])U3B
		float L_36 = V_2;
		float L_37 = V_3;
		...
		// if ((angle0Cos >U3D U2D1f && angle0Cos <U3D 1f) && (angle1Cos >U3D U2D1f && angle1Cos <U3D 1f))
		float L_44 = V_4;
	...
	{
		// outAngles[0] U3D Mathf.Acos(angle0Cos) * Mathf.Rad2DegU3B
		...
		L_51 = acosf(L_50);
		NullCheck(L_49);
		(L_49)->SetAt(static_cast<il2cpp_array_size_t>(0), (float)((float)il2cpp_codegen_multiply((float)L_51, (float)(57.2957802f))));
		// outAngles[1] U3D Mathf.Acos(angle1Cos) * Mathf.Rad2DegU3B
		...
		L_55 = acosf(L_54);
		NullCheck(L_53);
		(L_53)->SetAt(static_cast<il2cpp_array_size_t>(1), (float)((float)il2cpp_codegen_multiply((float)L_55, (float)(57.2957802f))));
	}
...
{
	{
		// set U7B m_Flip U3D valueU3B U7D
		bool L_0 = ___value0;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void LimbSolver2D_DoInitialize_m9B227AF3EE7EF95B43440E79EB89066843F9D71B (LimbSolver2D_t7853B3E9E5644B3A9FE624BCF58FD4279E5D2611 * __this, const RuntimeMethod* method)
{
	...
	{
		// m_Chain.transformCount U3D m_Chain.effector U3DU3D null U7CU7C IKUtility.GetAncestorCount(m_Chain.effector) < 2 U3F 0 : 3U3B
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void LimbSolver2D_DoPrepare_mBE932A922E069AB00BBB1D43D17513D8B418DEEB (LimbSolver2D_t7853B3E9E5644B3A9FE624BCF58FD4279E5D2611 * __this, const RuntimeMethod* method)
{
	...
	{
		// var lengths U3D m_Chain.lengthsU3B
		IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * L_0 = __this->get_m_Chain_9();
		NullCheck(L_0);
		...
		V_0 = L_1;
		// m_Positions[0] U3D m_Chain.transforms[0].positionU3B
		...
		// m_Positions[1] U3D m_Chain.transforms[1].positionU3B
		...
		// m_Positions[2] U3D m_Chain.transforms[2].positionU3B
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void LimbSolver2D_DoUpdateIK_mA69D30D60865E704661D4BF5FD6DFFFE62A893A3 (LimbSolver2D_t7853B3E9E5644B3A9FE624BCF58FD4279E5D2611 * __this, List_1_t577D28CFF6DFE3F6A8D4409F7A21CBF513C04181 * ___effectorPositions0, const RuntimeMethod* method)
{
	...
	{
		// float flipSign U3D flip U3F U2D1f : 1fU3B
		bool L_22;
...
IL_007c:
	{
		V_2 = G_B5_0;
		// m_Chain.transforms[0].localRotation *U3D Quaternion.FromToRotation(Vector3.right, effectorLocalPosition2D) * Quaternion.FromToRotation(m_Chain.transforms[1].localPosition, Vector3.right)U3B
		...
		// m_Chain.transforms[0].localRotation *U3D Quaternion.AngleAxis(flipSign * m_Angles[0], Vector3.forward)U3B
		...
		NullCheck(L_43);
		int32_t L_44 = 0;
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_45 = (L_43)->GetAt(static_cast<il2cpp_array_size_t>(L_44));
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_46 = L_45;
		NullCheck(L_46);
		Quaternion_t6D28618CF65156D4A0AD747370DDFD0C514A31B4  L_47;
		L_47 = Transform_get_localRotation_mA6472AE7509D762965275D79B645A14A9CCF5BE5(L_46, /*hidden argument*/NULL);
		...
		// m_Chain.transforms[1].localRotation *U3D Quaternion.FromToRotation(Vector3.right, m_Chain.transforms[1].InverseTransformPoint(effectorPosition)) * Quaternion.FromToRotation(m_Chain.transforms[2].localPosition, Vector3.right)U3B
		...
		NullCheck(L_56);
		int32_t L_57 = 1;
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_58 = (L_56)->GetAt(static_cast<il2cpp_array_size_t>(L_57));
		...
		NullCheck(L_63);
		int32_t L_64 = 1;
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_65 = (L_63)->GetAt(static_cast<il2cpp_array_size_t>(L_64));
		...
		NullCheck(L_70);
		int32_t L_71 = 2;
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_72 = (L_70)->GetAt(static_cast<il2cpp_array_size_t>(L_71));
		NullCheck(L_72);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void LimbSolver2D__ctor_m592941CDC674268A88E60FA51432B9CC67753B36 (LimbSolver2D_t7853B3E9E5644B3A9FE624BCF58FD4279E5D2611 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		// private Vector3[] m_Positions U3D new Vector3[3]U3B
		...
		// private float[] m_Lengths U3D new float[2]U3B
		...
		// private float[] m_Angles U3D new float[2]U3B
...
{
	{
		// get U7B return GetChainCount()U3B U7D
		int32_t L_0;
...
{
	{
		// get U7B return m_ConstrainRotationU3B U7D
...
{
	{
		// set U7B m_ConstrainRotation U3D valueU3B U7D
		bool L_0 = ___value0;
...
{
	{
		// get U7B return m_SolveFromDefaultPoseU3B U7D
...
{
	{
		// set U7B m_SolveFromDefaultPose U3D valueU3B U7D
		bool L_0 = ___value0;
...
{
	{
		// get U7B return HasTargets()U3B U7D
		bool L_0;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Solver2D_Validate_mDE546F070375AEC67486B07DAC9ACEB606646404 (Solver2D_t8A225947B36460AC49D5388511B3BBE7E03FB2B6 * __this, const RuntimeMethod* method)
{
	int32_t V_0 = 0;
	{
		// for (int i U3D 0U3B i < GetChainCount()U3B U2BU2Bi)
		V_0 = 0;
		goto IL_0018;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Solver2D_Prepare_m0119AF48F7073E9E64E97E208B9D564E8911F416 (Solver2D_t8A225947B36460AC49D5388511B3BBE7E03FB2B6 * __this, const RuntimeMethod* method)
{
	...
	int32_t G_B6_0 = 0;
	{
		// var rootTransform U3D GetPlaneRootTransform()U3B
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_0;
	...
	{
		// m_Plane.normal U3D rootTransform.forwardU3B
		...
		// m_Plane.distance U3D U2DVector3.Dot(m_Plane.normal, rootTransform.position)U3B
...
IL_0047:
	{
		...
		V_2 = L_13;
		// var constrainTargetRotation U3D constrainRotation && chain.target U21U3D nullU3B
		bool L_14;
...
IL_0066:
	...
	{
		// chain.RestoreDefaultPose(constrainTargetRotation)U3B
...
IL_000f:
	...
	{
		// m_TargetPositions.Add(chain.target.position)U3B
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Solver2D_UpdateIK_mA42642E47A3B527871C3128FE7520C66EBC5A0CB (Solver2D_t8A225947B36460AC49D5388511B3BBE7E03FB2B6 * __this, List_1_t577D28CFF6DFE3F6A8D4409F7A21CBF513C04181 * ___positions0, float ___globalWeight1, const RuntimeMethod* method)
{
	...
	IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * V_2 = NULL;
	{
		// if(positions.Count U21U3D chainCount)
...
IL_000f:
	{
		// float finalWeight U3D globalWeight * weightU3B
...
IL_0051:
	...
	{
		// chain.effector.rotation U3D chain.target.rotationU3B
		IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * L_15 = V_2;
		NullCheck(L_15);
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_16;
...
IL_0023:
	{
		V_2 = (bool)G_B4_0;
		// chain.BlendFkToIk(finalWeight, constrainTargetRotation)U3B
...
{
	{
		// protected virtual bool DoValidate() U7B return trueU3B U7D
		return (bool)1;
	}
}
// System.Void UnityEngine.U2D.IK.Solver2D::DoInitialize()
...
{
	{
		// protected virtual void DoInitialize() U7BU7D
		return;
	}
}
...
{
	{
		// protected virtual void DoPrepare() U7BU7D
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * Solver2D_GetPlaneRootTransform_m68283288A5D143586073C4C6A5F84C32DD256076 (Solver2D_t8A225947B36460AC49D5388511B3BBE7E03FB2B6 * __this, const RuntimeMethod* method)
{
	...
	{
		// return GetChain(0).rootTransformU3B
		IKChain2D_tDF0260969B3AF0AF72F7F6B0F881F028B8927D8F * L_1;
...
{
	{
		// return GetPlaneRootTransform().InverseTransformPoint(m_Plane.ClosestPointOnPlane(worldPosition))U3B
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_0;
		L_0 = VirtualFuncInvoker0< Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * >::Invoke(11 /* UnityEngine.Transform UnityEngine.U2D.IK.Solver2D::GetPlaneRootTransform() */, __this);
...
{
	{
		// return GetPlaneRootTransform().TransformPoint(planePoint)U3B
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_0;
		L_0 = VirtualFuncInvoker0< Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * >::Invoke(11 /* UnityEngine.Transform UnityEngine.U2D.IK.Solver2D::GetPlaneRootTransform() */, __this);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Solver2D__ctor_mD0FAAA85839E2CE1F6727F924EECA48F9CBA0E8C (Solver2D_t8A225947B36460AC49D5388511B3BBE7E03FB2B6 * __this, const RuntimeMethod* method)
{
	...
	{
		// private bool m_ConstrainRotation U3D trueU3B
		__this->set_m_ConstrainRotation_4((bool)1);
		// private bool m_SolveFromDefaultPose U3D trueU3B
		__this->set_m_SolveFromDefaultPose_5((bool)1);
		// private float m_Weight U3D 1fU3B
		__this->set_m_Weight_6((1.0f));
		// private List<Vector3> m_TargetPositions U3D new List<Vector3>()U3B
...
{
	{
		// get U7B return m_MenuPathU3B U7D
